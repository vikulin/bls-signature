...
public class CurveElement<E extends Element, F extends CurveField> extends AbstractPointElement<E, F> {
    ...
    CurveElement(CurveElement<E, F> curveElement) {
    ...
    public CurveElement setToRandom() {
        set(getField().getGenPow().pow(BigIntegerUtils.getRandom(field.getTargetField().getOrder())));
...
//        counter++;
    ...
    public boolean isEqual(Element e) {
        ...
        if (field.quotientCmp != null) {
            ...
            // representatives of the same cost.
    ...
    private boolean isEqual(CurveElement element) {
